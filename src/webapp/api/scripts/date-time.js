 ...
 * @name Timegrid.DateTime
 */

Timegrid.DateTime = new Object();

Timegrid.DateTime.MILLISECOND    = 0;
Timegrid.DateTime.SECOND         = 1;
Timegrid.DateTime.MINUTE         = 2;
Timegrid.DateTime.HOUR           = 3;
Timegrid.DateTime.DAY            = 4;
Timegrid.DateTime.WEEK           = 5;
Timegrid.DateTime.MONTH          = 6;
Timegrid.DateTime.YEAR           = 7;
Timegrid.DateTime.DECADE         = 8;
Timegrid.DateTime.CENTURY        = 9;
Timegrid.DateTime.MILLENNIUM     = 10;

Timegrid.DateTime.EPOCH          = -1;
Timegrid.DateTime.ERA            = -2;
 ...
 * Timegrid.DateTime object, e.g. Timegrid.DateTime.YEAR.
 * @type Array
 */
Timegrid.DateTime.gregorianUnitLengths = [];
    (function() {
        var d = Timegrid.DateTime;
...
Timegrid.DateTime._dateRegexp = new RegExp(
    "^(-?)([0-9]{4})(" + [
...
Timegrid.DateTime._timezoneRegexp = new RegExp(
    "Z|(([-+])([0-9]{2})(:?([0-9]{2}))?)$"
);
Timegrid.DateTime._timeRegexp = new RegExp(
 ...
 */
Timegrid.DateTime.setIso8601Date = function(dateObject, string) {
    /*
     *  This function has been adapted from dojo.date, v.0.3.0
     *  http://dojotoolkit.org/.
     */
     
    var d = string.match(Timegrid.DateTime._dateRegexp);
    if(!d) {
 ...
 * @return {Date} the modified date object
 */
Timegrid.DateTime.setIso8601Time = function (dateObject, string) {
    /*
     *  This function has been adapted from dojo.date, v.0.3.0
     *  http://dojotoolkit.org/.
     */
    
    var d = string.match(Timegrid.DateTime._timeRegexp);
    if(!d) {
        Timegrid.Debug.warn("Invalid time string: " + string);
        return false;
    }
    var hours = d[1];
 ...
 * @type Number
 */
Timegrid.DateTime.timezoneOffset = new Date().getTimezoneOffset();
 ...
 * @return {Date} the modified date object
 */
Timegrid.DateTime.setIso8601 = function (dateObject, string){
    /*
     *  This function has been adapted from dojo.date, v.0.3.0
     *  http://dojotoolkit.org/.
     */
    ...
    Timegrid.DateTime.setIso8601Date(dateObject, comps[0]);
    if (comps.length == 2) { 
        // first strip timezone info from the end
        var d = comps[1].match(Timegrid.DateTime._timezoneRegexp);
        if (d) {
            if (d[0] == 'Z') {
                offset = 0;
            } else {
        ...
        Timegrid.DateTime.setIso8601Time(dateObject, comps[1]); 
    }
    if (offset == null) {
 ...
 */
Timegrid.DateTime.parseIso8601DateTime = function (string) {
    try {
 ...
 */
Timegrid.DateTime.parseGregorianDateTime = function(o) {
    if (o == null) {
        return null;
 ...
 *   interval, e.g. Timegrid.DateTime.HOUR
 ...
 */
Timegrid.DateTime.roundDownToInterval = function(date, intervalUnit, timeZone, multiple, firstDayOfWeek) {
    var timeShift = timeZone * 
        Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.HOUR];
    ...
    switch(intervalUnit) {
    case Timegrid.DateTime.MILLISECOND:
        var x = date2.getUTCMilliseconds();
        date2.setUTCMilliseconds(x - (x % multiple));
        break;
    case Timegrid.DateTime.SECOND:
        date2.setUTCMilliseconds(0);
        
        var x = date2.getUTCSeconds();
        date2.setUTCSeconds(x - (x % multiple));
        break;
    case Timegrid.DateTime.MINUTE:
        date2.setUTCMilliseconds(0);
        date2.setUTCSeconds(0);
        
        var x = date2.getUTCMinutes();
        date2.setTime(date2.getTime() - 
            (x % multiple) * Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.MINUTE]);
        break;
    case Timegrid.DateTime.HOUR:
        date2.setUTCMilliseconds(0);
        date2.setUTCSeconds(0);
        ...
        break;
    case Timegrid.DateTime.DAY:
        clearInDay(date2);
        break;
    case Timegrid.DateTime.WEEK:
        clearInDay(date2);
        var d = (date2.getUTCDay() + 7 - firstDayOfWeek) % 7;
        date2.setTime(date2.getTime() - 
            d * Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.DAY]);
        break;
    case Timegrid.DateTime.MONTH:
        clearInDay(date2);
        date2.setUTCDate(1);
        ...
        break;
    case Timegrid.DateTime.YEAR:
        clearInYear(date2);
        
        var x = date2.getUTCFullYear();
        date2.setUTCFullYear(x - (x % multiple));
        break;
    case Timegrid.DateTime.DECADE:
        clearInYear(date2);
        date2.setUTCFullYear(Math.floor(date2.getUTCFullYear() / 10) * 10);
        break;
    case Timegrid.DateTime.CENTURY:
        clearInYear(date2);
        date2.setUTCFullYear(Math.floor(date2.getUTCFullYear() / 100) * 100);
        break;
    case Timegrid.DateTime.MILLENNIUM:
        clearInYear(date2);
 ...
 * @param {Number} firstDayOfWeek an integer specifying the first day of the
 *   week, 0 corresponds to Sunday, 1 to Monday, etc.
 * @see Timegrid.DateTime.roundDownToInterval
 */
Timegrid.DateTime.roundUpToInterval = function(date, intervalUnit, timeZone, multiple, firstDayOfWeek) {
    var originalTime = date.getTime();
    Timegrid.DateTime.roundDownToInterval(date, intervalUnit, timeZone, multiple, firstDayOfWeek);
    if (date.getTime() < originalTime) {
        date.setTime(date.getTime() + 
            Timegrid.DateTime.gregorianUnitLengths[intervalUnit] * multiple);
    }
};
 ...
 */
Timegrid.DateTime.incrementByInterval = function(date, intervalUnit, timeZone) {
    ...
    case Timegrid.DateTime.MINUTE:
        date2.setTime(date2.getTime() + 
            Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.MINUTE]);
        break;
    case Timegrid.DateTime.HOUR:
        date2.setTime(date2.getTime() + 
            Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.HOUR]);
 ...
 */
Timegrid.DateTime.removeTimeZoneOffset = function(date, timeZone) {
    return new Date(date.getTime() + 
        timeZone * Timegrid.DateTime.gregorianUnitLengths[Timegrid.DateTime.HOUR]);
};
 ...
 */
Timegrid.DateTime.getTimezone = function() {
